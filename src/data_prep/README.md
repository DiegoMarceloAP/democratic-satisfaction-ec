...
Preparación de datos (CRISP-DM: Data Preparation). ENEMDU y V-Dem parten de los CSV extraídos por SQL/Superset en `data/raw/` (sin cambios). Latinobarómetro parte de las descargas directas por ola en `data/raw/latinobarometro/` -- la extracción vía Superset tenía inconsistencias y no pudo utilizarse (ver limitaciones de la tesis).
